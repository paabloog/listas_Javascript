...
function verultimoelementodelalista(lista){
   ...
   // crea una función que nos devuelva si aparece un número en la lista o no
function busqueda(lista, números){
   for(var index=0; index <=lista.length;index++)
   if(lista[index]==números){
      return true;
   }
   return false;
}
